...
class CustomLoginView(LoginView):
    ...
    # method for redirecting to task detail page
...
class RegisterPage(FormView):
    ...
    def get(self, *args, **kwargs):
        """This method redirect the authenticated
...
class TaskList(LoginRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        """This method passes the tasks data to the template.
        ...
        # for searching the tasks on the basis of title
